function FProj=KatsevichFiltering(Proj,ProjScale,DecWidth,DecHeigh,ScanR,StdDis,HelicP,FilterCoeFF,DeltaAngle,FilteringMode, useGPU)
...
if useGPU
    FProj = Proj;
    KatsevichFiltering_GPU(Proj, ProjScale, DecWidth, DecHeigh, ScanR, StdDis, HelicP, FilterCoeFF, DeltaAngle, FilteringMode, YL, ZL, ProjNumber, FProj);
else
